...
(define csegen-24(delay (PreludeC-45Interfaces-traverse_ (force csegen-7) (force csegen-22) (lambda (u--k) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (string-append "  k=" (string-append (PreludeC-45Show-u--show_Show_Nat u--k) (string-append " n=" (PreludeC-45Show-u--show_Show_Integer (+ u--k 1))))) "\xa;") eta-0))))))
...
(define Main-n--3433-2811-u--checkInv (lambda (arg-0 arg-1 arg-2 arg-3 ext-0) (PreludeC-45IO-prim__putStr (string-append (string-append "  k=" (string-append (PreludeC-45Show-u--show_Show_Nat arg-3) (string-append " invariant: " (PreludeC-45Show-u--show_Show_Bool (PhysicsC-45ScalesC-45ScaleTrajectory-fingerprintInvariant arg-3))))) "\xa;") ext-0)))
...
(define PhysicsC-45ScalesC-45ScaleTrajectory-isGatePure (lambda (arg-0) (let ((u--reduced (PreludeC-45Types-u--foldl_Foldable_List (lambda (eta-0) (lambda (eta-1) (PhysicsC-45ScalesC-45ScaleTrajectory-divOut eta-0 eta-1))) (PreludeC-45Num-u--abs_Abs_Integer arg-0) (cons 2 (cons 3 (cons 5 (cons 7 (cons 11 (cons 13 '()))))))))) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer u--reduced 1))) (cond ((equal? sc0 1) 1) (else (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer arg-0 0)))))))
...
(define PhysicsC-45ScalesC-45ScaleTrajectory-coherentScaleCount (PreludeC-45TypesC-45List-lengthTR (PreludeC-45TypesC-45List-filterAppend '() (lambda (eta-0) (PhysicsC-45ScalesC-45ScaleTrajectory-isCoherentGeneration eta-0)) (PreludeC-45Types-u--rangeFromTo_Range_Nat 0 136))))
(define PhysicsC-45ScalesC-45ScaleTrajectory-decoherentScaleCount (PreludeC-45Types-prim__integerToNat (- 137 PhysicsC-45ScalesC-45ScaleTrajectory-coherentScaleCount)))
(define PhysicsC-45ScalesC-45ScaleTrajectory-eddingtonGeneration 39)
(define PhysicsC-45ScalesC-45ScaleTrajectory-eddingtonIsCoherent (PhysicsC-45ScalesC-45ScaleTrajectory-isCoherentGeneration 38))
...
(define PhysicsC-45ScalesC-45ScaleTrajectory-eddingtonIsMatterTimesResonance (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer PhysicsC-45ScalesC-45ScaleTrajectory-eddingtonGeneration (* (let ((sc0 PhysicsC-45EvolutionC-45Gate-MatterGate)) (let ((e-1 (cdr sc0))) e-1)) (let ((sc0 PhysicsC-45EvolutionC-45Gate-ResonanceGate)) (let ((e-1 (cdr sc0))) e-1)))))
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "=== Full 137-Scale Trajectory ===\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (string-append "  Grid wall: " (PreludeC-45Show-u--show_Show_Nat 137)) "\xa;") ext-0))) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (string-append "  Observer epoch: k=" (string-append (PreludeC-45Show-u--show_Show_Nat 38) (string-append " (n=" (string-append (PreludeC-45Show-u--show_Show_Integer PhysicsC-45ScalesC-45ScaleTrajectory-eddingtonGeneration) ")")))) "\xa;") ext-0))) (let ((act-5 (PreludeC-45IO-prim__putStr (string-append (string-append "  Eddington is coherent: " (PreludeC-45Show-u--show_Show_Bool PhysicsC-45ScalesC-45ScaleTrajectory-eddingtonIsCoherent)) "\xa;") ext-0))) (let ((act-6 (PreludeC-45IO-prim__putStr (string-append (string-append "  39 = 3 \xd7; 13: " (PreludeC-45Show-u--show_Show_Bool PhysicsC-45ScalesC-45ScaleTrajectory-eddingtonIsMatterTimesResonance)) "\xa;") ext-0))) (let ((act-7 (PreludeC-45IO-prim__putStr (string-append (string-append "  Gate-pure scales (of 137): " (PreludeC-45Show-u--show_Show_Nat PhysicsC-45ScalesC-45ScaleTrajectory-coherentScaleCount)) "\xa;") ext-0))) (let ((act-8 (PreludeC-45IO-prim__putStr (string-append (string-append "  Decoherent scales (of 137): " (PreludeC-45Show-u--show_Show_Nat PhysicsC-45ScalesC-45ScaleTrajectory-decoherentScaleCount)) "\xa;") ext-0))) (let ((act-9 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-10 (PreludeC-45IO-prim__putStr "--- Gate-Pure Generations (13-smooth numbers \x2264; 138) ---\xa;" ext-0))) (((let ((u--allScales (PreludeC-45Types-u--rangeFromTo_Range_Nat 0 136))) (let ((u--pureGens (PreludeC-45TypesC-45List-filterAppend '() (lambda (eta-0) (PhysicsC-45ScalesC-45ScaleTrajectory-isCoherentGeneration eta-0)) u--allScales))) (let ((u--decoGens (PreludeC-45TypesC-45List-filterAppend '() (lambda (eta-0) (let ((sc0 (PhysicsC-45ScalesC-45ScaleTrajectory-isCoherentGeneration eta-0))) (cond ((equal? sc0 1) 0) (else 1)))) u--allScales))) (lambda () (lambda (world-0) (let ((act-11 (((force csegen-24) u--pureGens) world-0))) (let ((act-12 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (let ((act-13 (PreludeC-45IO-prim__putStr (string-append (string-append "  Total gate-pure: " (PreludeC-45Show-u--show_Show_Nat (PreludeC-45TypesC-45List-lengthTR u--pureGens))) "\xa;") world-0))) (let ((act-14 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (let ((act-15 (PreludeC-45IO-prim__putStr "--- Decoherent Generations ---\xa;" world-0))) (let ((act-16 (((force csegen-24) u--decoGens) world-0))) (let ((act-17 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (let ((act-18 (PreludeC-45IO-prim__putStr (string-append (string-append "  Total decoherent: " (PreludeC-45Show-u--show_Show_Nat (PreludeC-45TypesC-45List-lengthTR u--decoGens))) "\xa;") world-0))) (let ((act-19 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (let ((act-20 (PreludeC-45IO-prim__putStr "--- Grid Wall (k=136, n=137) ---\xa;" world-0))) (let ((act-21 (PreludeC-45IO-prim__putStr "  137 is prime and NOT a gate prime\xa;" world-0))) (let ((act-22 (PreludeC-45IO-prim__putStr (string-append (string-append "  isCoherent(136) = " (PreludeC-45Show-u--show_Show_Bool (PhysicsC-45ScalesC-45ScaleTrajectory-isCoherentGeneration 136))) "\xa;") world-0))) (let ((act-23 (PreludeC-45IO-prim__putStr "  The grid wall IS decoherence \x2014; 137 itself is the boundary\xa;" world-0))) (let ((act-24 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (let ((act-25 (PreludeC-45IO-prim__putStr "--- Fingerprint Invariance Check ---\xa;" world-0))) (let ((act-26 (((PreludeC-45Interfaces-traverse_ (force csegen-7) (force csegen-22) (lambda (eta-0) (lambda (eta-1) (Main-n--3433-2811-u--checkInv u--allScales u--pureGens u--decoGens eta-0 eta-1)))) (cons 0 (cons 1 (cons 10 (cons 37 (cons 38 (cons 100 (cons 136 '())))))))) world-0))) (let ((act-27 (PreludeC-45IO-prim__putStr "\xa;" world-0))) (let ((act-28 (PreludeC-45IO-prim__putStr "--- Beyond the Wall (k=137, n=138) ---\xa;" world-0))) (let ((act-29 (PreludeC-45IO-prim__putStr "  138 = 2 \xd7; 3 \xd7; 23 \x2192; contains 23 (non-gate)\xa;" world-0))) (let ((act-30 (PreludeC-45IO-prim__putStr (string-append (string-append "  isCoherent(137) = " (PreludeC-45Show-u--show_Show_Bool (PhysicsC-45ScalesC-45ScaleTrajectory-isCoherentGeneration 137))) "\xa;") world-0))) (PreludeC-45IO-prim__putStr "  Beyond 137 is decoherent \x2014; the grid cannot extend\xa;" world-0))))))))))))))))))))))))))) ext-0)))))))))))))
